 ...
 */
final class Version20190802144405 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE partenaire ADD num_compt_p BIGINT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE partenaire DROP num_compt_p');
